...
reds_pitchers_hyper <- reds_pitchers_enhanced |>
  left_join(Reds_Pitcher_FE_24, by = join_by(MLBID == penult_pitcher)) |>
  left_join(Reds_Pitcher_FE_23, by = join_by(MLBID == antepenult_pitcher))
